# OpenChess — Phase 1 Task Board (ARCHIVED)

> **Status:** Archived 2026-07-14. Phase 1 delivered the playable Stockfish-family stack (board → search → NNUE bootstrap → Lazy SMP → UCI/TUI → opening book → Lichess CLI → arena).
> **Active board:** [tasks.md](./tasks.md) (Phase 2 — trained eval, measurement, Lichess go-live).
> **Carry-forward:** Unchecked **P8-02** (Syzygy) and **P8-04** (PGO/SIMD) move to Phase 2 as **K2-01** and **F2-01/F2-02**. Do not implement unfinished Phase 1 IDs from this archive — use the active board.
